export const SUBSERVICES_DETAIL_DATA = {
  // Web Design
  "static": {
  ...
  "dynamic": {
    ...
    whyChoose: "Dynamic websites are critical for businesses that require real-time content updates, user logins, and interactive features. We construct customized content management systems (CMS) and interactive portals that allow your team to manage data feeds effortlessly. Our database-driven architectures ensure your platform remains scalable, secure, and ready to support custom business logic.",
    visibleFeatures: [
  ...
  "ecommerce": {
    ...
    whyChoose: "Scale your online retail sales with a conversion-first digital store. We build fast, secure shopping pipelines equipped with robust product catalog management, secure checkout sequences, and dynamic invoice generation. Every store is optimized to handle high traffic volumes while providing a seamless, friction-free purchasing experience for your customers.",
    visibleFeatures: [
  ...
  "seo": {
    ...
    bodyVisual: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=800&q=80",
    whyChoose: "Rank organically above competitors for the highest-value search terms in your industry. At Ananya Hi Solutions, our SEO audits, backlink networks, and content strategies yield predictable, compounding organic customer leads. We focus on long-term visibility to ensure your website continues to capture high-intent buyers without ongoing ad spend.",
    visibleFeatures: [
  ...
  "smm": {
    ...
    whyChoose: "Build direct relationships with your followers and scale brand authority. We write high-engagement social copy, plan visual post calendars, and run conversion-optimized campaigns across Instagram, LinkedIn, and Facebook. Our strategy focuses on cultivating active online communities that turn casual social media scrolls into loyal customers.",
    visibleFeatures: [
  ...
  "content-marketing": {
    ...
    bodyVisual: "https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&w=800&q=80",
    whyChoose: "Establish authority and drive organic traffic through informative, search-optimized copy. We create blogs, visual infographics, and downloads that engage users and guide them down your marketing funnel. By delivering valuable insights to your audience, we build brand credibility and foster long-term customer relationships.",
    visibleFeatures: [
  ...
  "android": {
    ...
    whyChoose: "Engage billions of worldwide users with Kotlin-based Android apps. We focus on device compatibility, background service optimizations, and standard Google Play Store publishing workflows. Our custom architectures ensure your app performs reliably across a wide range of devices, delivering high performance and stability under any load.",
    visibleFeatures: [
  ...
  "single-vendor": {
    ...
    bodyVisual: "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?auto=format&fit=crop&w=800&q=80",
    whyChoose: "Launch a custom-branded storefront that sets you apart from marketplace noise. We build responsive checkout structures, high-performance category filters, and intuitive admin dashboards. This dedicated digital platform allows you to fully control your brand narrative, customer data, and marketing campaigns to build long-term value.",
    visibleFeatures: [
  ...
  "multi-vendor": {
    ...
    bodyVisual: "https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?auto=format&fit=crop&w=800&q=80",
    whyChoose: "Build an independent split-fee marketplace like Amazon. We engineer advanced multi-tenant merchant portals where sellers sign up, manage inventory, list catalog items, and view payouts. Our secure backend handles split-payment routing and global platform administration, enabling you to scale operations with minimal friction.",
    visibleFeatures: [
  ...
  "corporate": {
    ...
    whyChoose: "Present your company's core values, story, and executive profile through high-definition cinematic cuts. We structure scripting, location lighting, audio syncs, and multi-camera shoots. Our professional post-production team masters the color grading and audio mixing to deliver a powerful, brand-elevating video that wins client trust.",
    visibleFeatures: [
  ...
  "promo": {
    ...
    whyChoose: "Hook users immediately in the first 3 seconds of their feed. We structure script hooks, visual call-to-actions, and sound mixes to drive sales leads on Facebook, YouTube, and Instagram. Our data-backed approach to promotional video editing ensures your ads stand out, capture attention, and drive high click-through rates.",
    visibleFeatures: [
  ...
  "event": {
    ...
    bodyVisual: "https://images.unsplash.com/photo-1574717024653-61fd2cf4d44d?auto=format&fit=crop&w=800&q=80",
    whyChoose: "Re-live major summits, press conferences, and corporate launches. Our production crew manages stage lighting audio links, rapid highlight edits, and drone landscape shots. We capture the energy, key presentations, and attendee engagement of your events, delivering dynamic promotional reels that boost your brand's authority.",
    visibleFeatures: [
  ...
  "explainer": {
    ...
    bodyVisual: "https://images.unsplash.com/photo-1492691527719-9d1e07e534b4?auto=format&fit=crop&w=800&q=80",
    whyChoose: "Make complex software workflows or manufacturing processes simple to understand. We design character scripts, custom animations, and clean step-by-step product walkthrough animations. Our high-quality explainers guide prospects through your product's value proposition, significantly reducing support queries and boosting conversions.",
    visibleFeatures: [
  ...
  "social": {
    ...
    bodyVisual: "https://images.unsplash.com/photo-1574717024653-61fd2cf4d44d?auto=format&fit=crop&w=800&q=80",
    whyChoose: "Maximize feed views with high-engagement vertical loops. We format scripting hooks, compile kinetic subtitles, and master video cuts to satisfy algorithm placement trends. By keeping your brand at the forefront of social video trends, we help you capture viral reach and build a highly engaged following on Reels, TikTok, and Shorts.",
    visibleFeatures: [
  ...
  "music-video": {
    ...
    bodyVisual: "https://images.unsplash.com/photo-1492691527719-9d1e07e534b4?auto=format&fit=crop&w=800&q=80",
    whyChoose: "Bring your tracks to life with cinematic screenplays. Our creative directors script music videos, organize physical locations, master lighting setups, and run color-grading masters. We collaborate closely with artists to translate audio energy into stunning visual narratives that engage fans and elevate your brand presence.",
    visibleFeatures: [
  ...
  "short-films": {
    ...
    bodyVisual: "https://images.unsplash.com/photo-1574717024653-61fd2cf4d44d?auto=format&fit=crop&w=800&q=80",
    whyChoose: "Turn your scripts into cinematic reality. We manage full-scale actor casting calls, location scouting, set master design, dialogue recordings, and post-production masters. From screenwriting assistance to final cinema-grade rendering, our production team brings emotional depth and visual storytelling excellence to your project.",
    visibleFeatures: [
  ...
  "crm": {
    ...
    bodyVisual: "https://images.unsplash.com/photo-1551434678-e076c223a692?auto=format&fit=crop&w=800&q=80",
    whyChoose: "Off-the-shelf CRMs rarely match custom operational sales flows. We engineer custom client trackers, sales logs, and dashboard tools that sync with WhatsApp and email. This bespoke approach ensures your team can manage client relationships, track leads, and analyze sales performance in perfect alignment with your internal processes.",
    visibleFeatures: [
  ...
  "billing": {
    ...
    bodyVisual: "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?auto=format&fit=crop&w=800&q=80",
    whyChoose: "Automate shop checkouts and invoice filings. We construct POS billing panels that are GST-compliant, record transaction logs, print receipts, and work offline. Our secure systems streamline retail operations, manage multi-location inventory syncs, and generate comprehensive sales tax reports to simplify your accounting workflows.",
    visibleFeatures: [
  ...
  "college": {
    ...
    bodyVisual: "https://images.unsplash.com/photo-1551434678-e076c223a692?auto=format&fit=crop&w=800&q=80",
    whyChoose: "Streamline campus operations with a unified institution ERP database. We build secure student panels, fee logging systems, attendance grids, and faculty portals. Our comprehensive college management software connects departments, automates administrative task runs, and keeps parents informed through instant notification triggers.",
    visibleFeatures: [
  ...
  "lms": {
    ...
    bodyVisual: "https://images.unsplash.com/photo-1551434678-e076c223a692?auto=format&fit=crop&w=800&q=80",
    whyChoose: "Deliver secure educational courses. We build video player controls, student progress indicators, quiz modules, and digital PDF certificate generators. Our learning management systems are optimized to handle high concurrent user traffic, offering a smooth, interactive, and premium educational experience for online students.",
    visibleFeatures: [
